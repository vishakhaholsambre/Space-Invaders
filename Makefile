PRODUCT_NAME       = HW05
SOURCES            = main.c game.c myLib.c startScreen.c lose.c win.c pause.c sky.c spritesheet.c
CCPATH             = /usr/bin
DKPATH             = /Users/vishakhaholsambre/Documents/cs2261/setup/devkitARM/bin
VBASIM             = open /Users/vishakhaholsambre/Documents/cs2261/setup/visualboyadvance-m.app
FIND               = find
COPY               = cp -r
